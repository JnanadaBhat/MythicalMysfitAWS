...
export class MythicalMysfitProfileService {
  ...
  public retrieveMysfitProfiles(): Observable<MythicalMysfitResponse> {
    const data: MythicalMysfitProfile[] = [
      {
        ...
        lawchaos: 'Lawful',
        thumbImageUri:
          'https://www.mythicalmysfits.com/images/chimera_thumb.png',
      },
      {
        ...
        lawchaos: 'Lawful',
        thumbImageUri:
          'https://www.mythicalmysfits.com/images/cyclops_thumb.png',
      },
      {
        ...
        lawchaos: 'Chaotic',
        thumbImageUri:
          'https://www.mythicalmysfits.com/images/dragon_thumb.png',
      },
      {
        ...
        lawchaos: 'Neutral',
        thumbImageUri:
          'https://www.mythicalmysfits.com/images/gorgon_thumb.png',
      },
      {
      ...
      },
      {
        ...
        lawchaos: 'Chaotic',
        thumbImageUri:
          'https://www.mythicalmysfits.com/images/kraken_thumb.png',
      },
    ];
